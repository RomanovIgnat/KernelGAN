...
class Config:
    def __init__(self):
        ...
        # Iterations
        self.parser.add_argument('--max_iters', type=int, default=10000, help='# of iterations')
        ...
        self.parser.add_argument('--weakly_supervised_path', default='/content/gdrive/MyDrive/for_ws_kernel_gan/0830kerTest.png')
