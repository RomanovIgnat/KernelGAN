...
class Config:
    def __init__(self):
        ...
        # Iterations
        self.parser.add_argument('--max_iters', type=int, default=20000, help='# of iterations')
        ...
        self.parser.add_argument('--weakly_supervised_path', default=None) # '/content/gdrive/MyDrive/for_ws_kernel_gan/0830kerTest.png')
        self.parser.add_argument("--ground_truth_kernel_path", default='/content/gdrive/MyDrive/ground_truth_kernels/0830_kernel_x2.txt')
